...
# class user:
#     pass # we use pass if we don't have anything to write in body of a class or a function or in
#          # a loop or a conditional statement and we wanna get rid of indentation error
# user_1 = user()

# # PascalCase, camelCase, snake_case
# # we use PascalCase for class names and snake_case for everything else, camelCase isn't much used in py
...
# # constructor can help reduce the code as we are constructing the objects with attributes
